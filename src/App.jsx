  ...
  return (
    <div className="flex group justify-center items-center w-full h-full">
      <div className="flex flex-col basis-0 flex-grow items-end opacity-0 -translate-x-2 duration-200 group-hover:opacity-100 group-hover:translate-x-0">
		<button className="wasd-button text-white" style={{ backgroundColor: colorMap.Early }} onClick={simulateEarly}>Early</button>
		<button className="wasd-button text-white" style={{ backgroundColor: colorMap.Late }} onClick={simulateLate}>Late</button>
		<button className="wasd-button text-white" style={{ backgroundColor: colorMap.Perfect }} onClick={simulatePerfect}>Perfect</button>
      </div>
